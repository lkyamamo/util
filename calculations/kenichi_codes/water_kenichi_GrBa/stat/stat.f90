module stat_mod
  ...
  integer,parameter :: NTABLES = 1000, NTABLES_BA=900, NTABLES_SQ=1000
...
!                       !bond_length('Na','O',2.0d0) &
  ...
  type(AFF_type),parameter :: AFF0(8)=[ &
          ...
          !Siv lampx
          !AFF_type(name='Si', a=[6.2915d0, 3.0353d0, 1.9891d0, 1.541d0], & 
          !         b=[2.4386d0, 32.3337d0, 0.6785d0, 81.6937d0], c=1.1407d0), &
          !Sival lampx
          !AFF_type(name='Si', a=[5.66269d0, 3.07164d0, 2.62446d0, 1.3932d0], &
          !         b=[2.6652d0, 38.6634d0, 0.916946d0, 93.5458d0], c=1.24707d0), &
          !Si4+ from lampx
          AFF_type(name='Si', a=[4.43918d0, 3.20345d0, 1.19453d0, 0.41653d0], &
                   b=[1.64167d0, 3.43757d0, 0.2149d0, 6.65365d0], c=0.746297d0) &
          ]
