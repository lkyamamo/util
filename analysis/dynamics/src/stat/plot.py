...
def gr_plot(dirs, num_gr=2):
    ...
    for dir in dirs:
        for infile in glob.glob(dir+'/gr.dat'):
            ...
            fig = plt.figure(figsize=(20*num_gr, 16*num_gr))
            ...
            for c in range(num_pairs):
                ...
                subplots.legend()
                #subplots.grid()
                subplots.grid(which='major', color='red', linewidth=1.0)
                subplots.grid(which='minor', color='orange', linestyle=':', linewidth=0.8)
